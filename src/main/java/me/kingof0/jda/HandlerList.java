...
public class HandlerList {
     ...
     */
    public static void unregisterAll(JDA plugin) {
        synchronized (allLists) {
            for (HandlerList h : allLists) {
                h.unregister(plugin);
            }
     ...
     */
    private synchronized void register(RegisteredListener listener) {
     ...
     *
     * @param api plugin to remove
     */
    public synchronized void unregister(JDA api) {
        boolean changed = false;
        for (List<RegisteredListener> list : handlerslots.values()) {
            for (ListIterator<RegisteredListener> i = list.listIterator(); i.hasNext();) {
                if (i.next().getApi().equals(api)) {
                    i.remove();
                    changed = true;
                }
            }
     ...
     * handler list
     *
     * @param api the plugin to get the listeners of
     * @return the list of registered listeners
     */
    public static ArrayList<RegisteredListener> getRegisteredListeners(JDA api) {
